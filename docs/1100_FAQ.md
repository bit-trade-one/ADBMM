...
### Q6：<a href="#BMMFAQ6">モバイルバッテリからの給電が止まる</a><br><br>    

## 美耳変換機  
### Q1：<a href="#UADFAQ1">手持ちのiPhoneはLightning端子ですが、接続できますか？ またiPhone 15以降はどうなりますか？</a>
### Q2：<a href="#UADFAQ2">全てのアンドロイド端末で使用できますか?</a>
### Q3：<a href="#UADFAQ3">スマホで使う場合、専用アプリは必要ですか？</a>
### Q4：<a href="#UADFAQ4">電源はどうやって供給しますか？</a>
### Q5：<a href="#UADFAQ5">美耳以外のマイクでも使えますか？</a>
### Q6：<a href="#UADFAQ6">3.5mmステレオ出力でスピーカーを鳴らせますか？</a>
### Q7：<a href="#UADFAQ7">美耳のように回路図の公開はありますか？</a>
...
<h1 id="UADFAQ1">Q1：手持ちのiPhoneはLightning端子ですが、接続できますか？ またiPhone 15以降はどうなりますか？ </h1>

### A： Lightning端子のiPhoneはサポート対象外となります。  

iPhone 15シリーズ以降はUSB Type-C端子を搭載しているため、本製品と直接Type-Cケーブルでつなぐだけでよりシンプルに接続可能です。  
なお、すべてのiOSデバイスやOSバージョンでの動作を完全に保証するものではありません。  

---
<br>
<h1 id="UADFAQ2">Q2：全てのアンドロイド端末で使用できますか? </h1>

### A：USB Audio Class 2.0に対応している必要があります。  

サポートしている端末は[動作対応機種リスト](https://bit-trade-one.github.io/ADBMM/500_Converter_Compatible_models.html)をご覧ください。

---
<br>
<h1 id="UADFAQ3">Q3：スマホで使う場合、専用アプリは必要ですか？ </h1>

### A：一般的なカメラアプリや録音アプリを使用できます  

アプリケーション側でステレオ音声に対応している必要があります。

---
<br>
<h1 id="UADFAQ4">Q4：電源はどうやって供給しますか？ </h1>

### A：USB Type-C経由でスマホやPCからバスパワーで供給されます。   

別途電源は不要です。

---
<br>
<h1 id="UADFAQ5">Q5：美耳以外のマイクでも使えますか？ </h1>

### A：6.3mmモノラルジャックを二本使用したステレオ入力（プリアンプ／民生ラインレベルを想定）であれば利用可能です。


---
<br>
<h1 id="UADFAQ6">Q6：3.5mmステレオ出力でスピーカーを鳴らせますか？ </h1>

### A：ヘッドホン・イヤホン接続を想定しています。  

スピーカーへ接続した場合は別途アンプなどが必要になる場合があります。  

---
<br>
<h1 id="UADFAQ7">Q7：美耳のように回路図の公開はありますか？ </h1>

### A：恐れ入りますが公開の予定はありません  

本製品は[CM6646開発ボード](https://www.cmedia.com.tw/products/USB_AUDIO_CODEC/CM6646#:~:text=DemoBoard%20Schematics)を準拠して設計しております。
